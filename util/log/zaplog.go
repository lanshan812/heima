...
func InitLog() {
	Logger = createZapLog(logHandler)
}

func createZapLog(entry func(zapcore.Entry) error) *zap.Logger {
	...
	timePrecision := viper.GetString("Log.timePrecision")
	...
	//写入器
	fileName := viper.GetString("Log.appLogName")
